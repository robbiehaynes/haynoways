  ...
  return (
    <>
      <div className="h-screen flex items-center justify-center flex-col space-y-14">
        <div className="text-7xl text-center text-shadow text-brand-gunmetal font-bold font-pacifico [text-wrap:balance] bg-clip-text">the <span className="inline-flex flex-col h-[calc(theme(fontSize.7xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.7xl)*theme(lineHeight.tight))] overflow-hidden">
        ...
        <h4 className="text-2xl text-shadow-sm text-brand-gunmetal font-jua">My actual name is Rob<br/>I'm a full-stack developer.</h4>
        <input
          className="w-3/4 lg:w-1/2 px-4 py-4 border bg-brand-gunmetal border-gray-300 font-jua text-slate-200 placeholder-slate-200 rounded-2xl"
          type="text"
