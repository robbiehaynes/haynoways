  ...
  return (
    <>
      <div className="h-screen flex items-center justify-center flex-col space-y-14">
        <div className="text-7xl text-center text-shadow text-white font-bold font-pacifico [text-wrap:balance] bg-clip-text">the <span className="inline-flex flex-col h-[calc(theme(fontSize.7xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.7xl)*theme(lineHeight.tight))] overflow-hidden">
        ...
        <h4 className="text-2xl text-shadow-sm text-white font-jua">My actual name is Rob<br/>I'm a full-stack developer.</h4>
        <input
