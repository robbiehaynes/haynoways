  ...
  return (
    <>
      <div className="h-screen flex items-center justify-center flex-col space-y-14">
        <div className="text-7xl text-center text-shadow-sm text-brand-coral font-bold font-pacifico [text-wrap:balance] bg-clip-text">the <span className="text-brand-coral inline-flex flex-col h-[calc(theme(fontSize.7xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.7xl)*theme(lineHeight.tight))] overflow-hidden">
        ...
        <h4 className="text-2xl text-shadow-sm text-white opacity-65 font-jua">My actual name is Rob<br/>I'm a full-stack developer.</h4>
        <input
