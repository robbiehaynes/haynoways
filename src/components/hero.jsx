  ...
  return (
    <>
      <div className="h-screen flex items-center justify-center flex-col space-y-14">
        <div className="text-6xl md:text-7xl text-center text-shadow text-brand-gunmetal font-bold font-pacifico [text-wrap:balance] bg-clip-text">the <span className="inline-flex flex-col h-[calc(theme(fontSize.6xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.7xl)*theme(lineHeight.tight))] overflow-hidden">
